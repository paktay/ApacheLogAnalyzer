...
//        int jsonFileNumber = 1;
        while ((line = reader.readLine()) != null) {
            ...
            if(FilterUrl.validate(url, args)) {
...
//        }
        ...
        writeToFile(sortedSummary, summary, "ip", "urls", fileName + "_ip.json");        
        summary.clear();
        
        writeToFile(sortedSummary2, summary2, "url", "ips", fileName + "_url.json");
        summary2.clear();
...
*/
    ...
    private static void writeToFile(
        ...
        FileWriter writer = new FileWriter("data/"+_fileName);
        writer.write(gson.toJson(jsonArray));
        writer.close();
    }
...
//        );
        ...
        public static ArrayList<String> ReadFileLineByLine(String _file) 
...
//            }
        ...
        public static boolean validate(String url, String[] args) {
            boolean result = false;
            if(args != null && args.length == 2) {
                //ArrayList<String> urls = new ArrayList<>();
                try {
                    if(urls == null) {
                        urls = ReadFileLineByLine(args[1]);
                    }
                } catch (IOException e) {
                    e.printStackTrace();
                }
